...
class Watchlist extends StatelessWidget {
  ...
  Future<List<Map<String, dynamic>>> movieData() async {
    if (watchPage.length == 0) {
      List<Map<String, dynamic>> movies = [];
      for (var element in watchlist.reversed.toList()) {
  ...
  Future<List<Map<String, dynamic>>> tvshowData() async {
    if (watchPageTVShows.length == 0) {
      List<Map<String, dynamic>> movies = [];
      for (var element in watchlistTVShows.reversed.toList()) {
        Map<String, dynamic> data = {};
        dynamic type = element[0];
        dynamic id = element[1];
        if (type == "TVShows") {
      ...
      watchPageTVShows = movies;
      return movies;
    } else {
      return watchPageTVShows;
    }
  }
